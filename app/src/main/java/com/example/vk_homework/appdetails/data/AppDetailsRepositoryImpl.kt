...
class AppDetailsRepositoryImpl @Inject constructor() : AppDetailsRepository {
    override fun getAppDetails(): AppDetails {
        val dto = AppDetailsDto(
            id = 1,
            categoryId = 1,
            rawName = "Гильдия героев",
            developerName = "VK Group",
            categoryTitle = "Игры",
            ageLimit = 12,
            sizeInMb = 124.5f,
            iconPath = "https://static.rustore.ru/imgproxy/APsbtHxkVa4MZ0DXjnIkSwFQ_KVIcqHK9o3gHY6pvOQ/preset:web_app_icon_62/plain/https://static.rustore.ru/apk/393868735/content/ICON/3f605e3e-f5b3-434c-af4d-77bc5f38820e.png@webp",
            screenshots = listOf(
            ...
            fullDescription = "Легендарный рейд героев в Фэнтези РПГ. Станьте героем гильдии и сразите мастера подземелья!"
        )
        return dto.toDomain()
    }
}