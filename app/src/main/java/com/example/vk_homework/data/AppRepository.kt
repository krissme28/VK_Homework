package com.example.vk_homework.data

import com.example.vk_homework.appdetails.AppCategory
import com.example.vk_homework.applist.AppListItem

class AppRepository {
    fun getApps(): List<AppListItem> {
        return listOf(
            AppListItem(
                name = "Яндекс Карты и Навигатор",
                appCategory = AppCategory.TRANSPORT,
            ...
            AppListItem(
                ...
                appCategory = AppCategory.COMMUNICATION,
            ...
            AppListItem(
                ...
                appCategory = AppCategory.PURCHASES,
            ...
            AppListItem(
                ...
                appCategory = AppCategory.FINANCE,
